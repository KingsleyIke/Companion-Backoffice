          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _NavItem(icon: Icons.location_city_outlined, label: 'Parishes',   route: AppRoutes.parishes,   location: location),
                _NavItem(icon: Icons.menu_book_outlined,   label: 'Readings',   route: AppRoutes.readings,   location: location),
                _NavItem(icon: Icons.people_outline,       label: 'Users',      route: AppRoutes.users,      location: location),
                _NavItem(
